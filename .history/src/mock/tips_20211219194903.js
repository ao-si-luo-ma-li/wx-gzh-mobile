...
export const classifyDetial = {
  yanchu: {
    title: require('@/assets/images/classifylist/ww_yanchu.png'),
    book: require('@/assets/images/classifylist/book_yanchu.jpg'),
    video: '',
  },
  dongman: {
    title: require('@/assets/images/classifylist/ww_dongman.png'),
    book: require('@/assets/images/classifylist/book.jpg'),
    video: '',
  },
  yinyue: {
    title: require('@/assets/images/classifylist/ww_yinyue.png'),
    book: require('@/assets/images/classifylist/book.jpg'),
    video: '',
  },
  gbbj: {
    title: require('@/assets/images/guangbo/gb_guangbo.png'),
  ...
  yinyan: {
    title: require('@/assets/images/guangbo/gb_yinyan.png'),
...
export const businessDetial = {
  yanchu: {
    title: require('@/assets/images/simp_wangwen/ww_yanchu1.png'),
    content: `
    视频直播网文，即申请网络文化经营许可证
