<template>
  <div class="simp-classify-list">
    <div class="img-top-wrap">
      <img :src="businessDetial.title" alt="" srcset="" class="png-title" />
    ...
    <div class="img-middle-wrap">
      ...
      <div class="content">
        <div v-html="businessDetial.content"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    console.log('businessDetial +++++++++++++++', this.businessDetial);
  },
};
</script>
