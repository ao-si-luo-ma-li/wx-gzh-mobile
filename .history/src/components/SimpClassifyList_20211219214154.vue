  ...
  <div :class="`simp-classify-list ${isWW ? 'ww' : ''}`">
    ...
    <div class="img-middle-wrap">
      <div class="action-list">
        ...
        >
          <img :src="action2" alt="" srcset="" class="action action-2" />
        </router-link>
        <router-link
      ...
      <div class="img-bottom-wrap">
        ...
        <div v-if="isEDI_ICP">
          ...
          >
            <source
              src="http://www.k-joys.com/ICP%E5%B9%B4%E6%A3%80%E8%A7%86%E9%A2%912021%E7%89%88.mp4"
              type="video/mp4"
            />
            <p class="vjs-no-js">
              暂无视频
...
export default {
  ...
  data() {
    return {
      ...
      action3_ww: require('@/assets/images/simpClassifylist/action-3__.png'),
