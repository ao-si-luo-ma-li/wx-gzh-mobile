<template>
  <div class="apply-root">
    <div class="apply-cost">
      <div :class="`apply-title ${isWW ? 'ww' : ''}`">
        <img :src="cost.title" alt="" srcset="" class="png-title" />
        <img
...
export default {
  ...
  mounted() {
    ...
    this.table = table;
    this.remark = remark;
    this.isWW = isWenWangWen.findIndex(ww => location.href.includes(ww)) > -1;
  },
  props: {
    cost: Array,
  },
...
.apply-cost {
  ...
  min-height: 100vh;
  background-image: url(../assets/images/simp_bg/simp-bg.png) no-repeat center;
  background-size: 100% 100%;
  background-position: 0 0;

  &.ww {
    background-image: url(../assets/images/simp_bg/ww-simp-bg.jpg) no-repeat
      center;
  }
